...
- foi usada a seguinte palleta de cores para designar o estado dos registradores.
const PALETTE = { 
    empty: white,
    correctAnswer: blue,
    lastAlocated: salmon,
...
- mais importantemente: roxo = ocupado, branco = vazio, salmao se foi o registrador mais recentemente adicionado
